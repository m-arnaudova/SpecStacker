...
This is a new rest-frame spectral stacking code for galaxies and AGN spectra. For a quick start-up tutorial, see [example](https://nbviewer.org/github/m-arnaudova/SpecStacker/blob/main/example.ipynb) notebook.
